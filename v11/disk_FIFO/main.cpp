...
Metodu uputi_UI_zahtev pozivaju niti koje predstavljaju procese. U ovoj metodi prosleđuje 
se zahtev UI uređaju da izvrši UI operaciju na određenoj stazi diska. Proces mora da sačeka 
da zahtev bude izvršen, pre nego nastavi dalje izvršavanje.

Metodu obradi_zahtev poziva nit koja predstavlja disk. Metoda je zadužena da obradi jedan 
zahtev iz skupa zahteva. Zahtev za obradu se iz skupa zahteva bira po FIFO principu. Obrada 
zahteva traje 300 ms. Rezultat metode je broj staze kojoj je disk pristupio pri obradi zahteva.
*/
...
{
	// Da ne bi došli svi zahtevi istovremeno
	this_thread::sleep_for(milliseconds(kasnjenje));
...
void testirajSve() 
{
	...
	int kasnjenje[]     = {10, 20, 30, 40, 50,  60,  70, 80,  90};  
