...
pozivom operacije Memorija.pisi, a čitanje pozivom operacije Memorija.citaj. I čitanje i upis 
svake vrednosti traje po 1 sekundu. Ove dve metode kao parametar prihvataju memorijsku lokaciju 
(ona je izražena u bajtima/karakterima). Interno, sve lokacije koji čine memoriju mogu se 
predstaviti karakterima (tip char).
...
lokacija (bajt) pripada. Dakle, operacija upisa ne dozvoljava da paralelno sa njom teče b
ilo koja druga operacija (čitanje ili neki drugi upis u istu memorijsku reč).
...
Ako istovremeno postoje i procesi koji žele da čitaju i procesi koji žele da pišu u istu 
memorijsku reč, prvo treba procesi koji čitaju da dobiju pristup.

Implementirati označene metode, konstruktor i dodati privatne članove u klasu Memorija.
*/
