...
Za svaku učionicu potrebno je evidentirati naziv učionice, kvadraturu 
i sve računare koji se nalaze u učionici. 
...
class Ucionica {
	...
	public:
		...
		void set_kvadratura(double k)
		{
			kvadratura = k;
		}
		double get_kvadratura()
		{
			return kvadratura;
		}
		void dodaj_racunar(Racunar r)
		{
			racunari.push_back(r);
		}
		list<Racunar> get_racunari()
		{
			return racunari;
		}
};
