/*
Modelovati koriscenje racunara u racunarskoj ucionici. Broj racunara u ucionici se prosledjuje 
pri inicijalizaciji. Student pozivom operacije zauzmi() dolazi u ucionicu i zauzima prvi 
slobodan racunar, ukoliko takav racunar postoji.
...
Operacijom oslobodi(), student zavrsava rad u ucionici. Parametar metode je redni broj racunara 
koji student koristi i koji treba da se oslobodi.
...
void student(RC &rc, int br_indeksa) 
{
    ...
    int id_racunara = rc.zauzmi(br_indeksa); 
    ...
    rc.oslobodi(br_indeksa, id_racunara); 
}
