...
void testirajSve() 
{
	...
	// ulaz na koji automobil ide i broj sekundi koliko se zadrzava zavise od rednog broja automobila
	// bitno je da na svakom ulazu dobijemo jednak broj automobila
