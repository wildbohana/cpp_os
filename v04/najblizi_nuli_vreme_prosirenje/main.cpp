...
int main() 
{
	...
	// PROSIRENJE - ispis trajanja za svaku od niti u ms, s i min.
	for (int i = 0; i < BROJ_NITI; i++)
	{
		...
		cout << endl << "Nit " << i+1 << " se izvrsavala: " << endl;
		cout << trajanje_mili.count() << " milisekundi." << endl;
		cout << trajanje_sek.count() << " sekundi." << endl;
		cout << trajanje_min.count() << " minuta." << endl;
	}
}
